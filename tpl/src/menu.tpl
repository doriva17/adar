    ...
    <div id="menu">
		...
		<div class="menu_item {if $menue=='lecturer_paper_list'}menu_item_selected{/if}">
			<a href="?m=lecturer_paper_list"><img src="vendor/koala-framework/library-silkicons/page_add.png" />Supervisor Panel</a></div>
		<div class="menu_item {if $menue=='Moderator_paper_list'}menu_item_selected{/if}">
			<a href="?m=Moderator_paper_list"><img src="vendor/koala-framework/library-silkicons/page_add.png" />Moderator Panel</a></div>
