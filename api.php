...
elseif($requestData['source']=="papers"){
  ...
  2=> array(false, 'dateModerated', false),
  3 => array(false, 'lecturerId', false),
  4 => array(false, 'moderatorId', false),
  5 => array(false, 'studentNumber', false),
  6 => array(false, 'coordinatorId', false),
  7 => array(false, 'clusterId', false),
  8 => array(false, 'publishedStatus', false),
  //9 => array(false, 'abstract', false),
  9 => array(false, 'lecturer_marks', false), // here is the test change
  10 => array(false, 'moderator_marks', false) // another test change
  //12 => array(false, 'lecturer_markingGrid', false),
  //13 => array(false, 'moderator_markingGrid', false)
);
...
if(!empty($requestData['search']['value'])) {
    $sql_filter.="
        AND (
            ...
            `publishedStatus` LIKE ? OR
            //`abstract` LIKE ? OR
            `lecturer_marks` LIKE ? OR
            `moderator_marks` LIKE ? OR
            //`lecturer_markingGrid` LIKE ? OR
            //`moderator_markingGrid` LIKE ? OR
        ) ";
        $sql_filter_data[] = '%'.$requestData['search']['value'].'%';
        $sql_filter_data[] = '%'.$requestData['search']['value'].'%';
        $sql_filter_data[] = '%'.$requestData['search']['value'].'%';
