...
if(!$GLOBALS['adlerweb']['session']->session_isloggedin()) {
  ...
  if(empty($student)) {
    echo "Entered student number was not found in the database! <br>";
    $GLOBALS['adlerweb']['tpl']->assign('titel',  'No record found!');

    $GLOBALS['adlerweb']['tpl']->assign('modul',  'error');
    $GLOBALS['adlerweb']['tpl']->assign('errstr', 'Entered student number was not found in the database!'.$back);
